...
{% include figure.html image="../../../../../Transitions_results.png" caption="Strategies (short and long-term) for each style transition challenge, as well external guidance received" position="center" width="900" height="900"%}
